...
class TPHF_Target_Rules_Fields {
	...
	public static function get_location_selections() {
		...
		$special_pages = array(
			'special-404'    => __( '404 Page', 'themephi-header-footer-elementor' ),
			'special-search' => __( 'Search Page', 'themephi-header-footer-elementor' ),
			'special-blog'   => __( 'Blog / Posts Page', 'themephi-header-footer-elementor' ),
			'special-front'  => __( 'Front Page', 'themephi-header-footer-elementor' ),
			'special-date'   => __( 'Date Archive', 'themephi-header-footer-elementor' ),
			'special-author' => __( 'Author Archive', 'themephi-header-footer-elementor' ),
		);

		if ( class_exists( 'WooCommerce' ) ) {
			$special_pages['special-woo-shop'] = __( 'WooCommerce Shop Page', 'themephi-header-footer-elementor' );
		}

		$selection_options = array(
			'basic'         => array(
				'label' => __( 'Basic', 'themephi-header-footer-elementor' ),
				'value' => array(
					'basic-global'    => __( 'Entire Website', 'themephi-header-footer-elementor' ),
					'basic-singulars' => __( 'All Singulars', 'themephi-header-footer-elementor' ),
					'basic-archives'  => __( 'All Archives', 'themephi-header-footer-elementor' ),
				),
			),

			'special-pages' => array(
				'label' => __( 'Special Pages', 'themephi-header-footer-elementor' ),
				'value' => $special_pages,
			),
		);
		...
		$selection_options['specific-target'] = array(
			'label' => __( 'Specific Target', 'themephi-header-footer-elementor' ),
			'value' => array(
				'specifics' => __( 'Specific Pages / Posts / Taxonomies, etc.', 'themephi-header-footer-elementor' ),
			),
		);
	...
	public static function get_user_selections() {
		$selection_options = array(
			'basic'    => array(
				'label' => __( 'Basic', 'themephi-header-footer-elementor' ),
				'value' => array(
					'all'        => __( 'All', 'themephi-header-footer-elementor' ),
					'logged-in'  => __( 'Logged In', 'themephi-header-footer-elementor' ),
					'logged-out' => __( 'Logged Out', 'themephi-header-footer-elementor' ),
				),
			),

			'advanced' => array(
				'label' => __( 'Advanced', 'themephi-header-footer-elementor' ),
				'value' => array(),
			),
		);
	...
	public function admin_styles() {
		...
		$localize_vars = array(
			'ast_lang'      => $ast_lang,
			'please_enter'  => __( 'Please enter', 'themephi-header-footer-elementor' ),
			'please_delete' => __( 'Please delete', 'themephi-header-footer-elementor' ),
			'more_char'     => __( 'or more characters', 'themephi-header-footer-elementor' ),
			'character'     => __( 'character', 'themephi-header-footer-elementor' ),
			'loading'       => __( 'Loading more results…', 'themephi-header-footer-elementor' ),
			'only_select'   => __( 'You can only select', 'themephi-header-footer-elementor' ),
			'item'          => __( 'item', 'themephi-header-footer-elementor' ),
			'char_s'        => __( 's', 'themephi-header-footer-elementor' ),
			'no_result'     => __( 'No results found', 'themephi-header-footer-elementor' ),
			'searching'     => __( 'Searching…', 'themephi-header-footer-elementor' ),
			'not_loader'    => __( 'The results could not be loaded.', 'themephi-header-footer-elementor' ),
			'search'        => __( 'Search pages / post / categories', 'themephi-header-footer-elementor' ),
	...
	public static function target_rule_settings_field( $name, $settings, $value ) {
		...
		$add_rule_label = isset( $settings['add_rule_label'] ) ? $settings['add_rule_label'] : __( 'Add Rule', 'themephi-header-footer-elementor' );
		$saved_values   = $value;
		$output         = '';
		...
		$output .= '<option value="">' . __( 'Select', 'themephi-header-footer-elementor' ) . '</option>';
	...
	public static function get_post_target_rule_options( $post_type, $taxonomy ) {
		...
		$all_posts                          = sprintf( __( 'All %s', 'themephi-header-footer-elementor' ), $post_label );
		$post_option[ $post_name . '|all' ] = $all_posts;

		if ( 'pages' != $post_key ) {
			/* translators: %s post label */
			$all_archive                                = sprintf( __( 'All %s Archive', 'themephi-header-footer-elementor' ), $post_label );
		...
		if ( in_array( $post_type->name, $taxonomy->object_type ) ) {
			...
			$tax_archive = sprintf( __( 'All %s Archive', 'themephi-header-footer-elementor' ), $tax_label );
	...
	public static function generate_target_rule_selector( $type, $selection_options, $input_name, $saved_values, $add_rule_label ) {
		...
		if ( 'display' == $type ) {
			...
			$output .= '<a href="#" class="button">' . __( 'Add Exclusion Rule', 'themephi-header-footer-elementor' ) . '</a>';
			$output .= '</div>';
		}
		...
		if ( ! empty( $already_set_rule ) ) {
			add_action(
				...
				function() use ( $already_set_rule ) {
					...
					$notice = sprintf( __( 'The same display setting is already exist in %s post/s.', 'themephi-header-footer-elementor' ), $rule_set_titles );
	...
	public static function get_post_selection( $post_type ) {
		...
		if ( ! empty( $all_headers ) ) {
			$headers = array(
				'' => __( 'Select', 'themephi-header-footer-elementor' ),
			);
