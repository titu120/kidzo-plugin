...
class FT_Event1_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('FT Event1', 'ftelements');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Our School Event', 'ftelements'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Looks Matter A Lot For Kids Events', 'ftelements'),
                'rows' => 2,
            ]
        );
        ...
        $this->add_control(
            'section_bg_image',
            [
                'label' => esc_html__('Section Background Image', 'ftelements'),
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => $theme_uri . '/assets/img/home-1/classes-bg.png',
                ],
            ]
        );
        ...
        $this->add_control(
            'date_badge_image',
            [
                'label' => esc_html__('Date Badge Image', 'ftelements'),
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => $theme_uri . '/assets/img/inner-page/date.png',
                ],
            ]
        );
        ...
        $this->add_control(
            'arrow_icon_svg',
            [
                'label' => esc_html__('Arrow Icon SVG (Upload)', 'ftelements'),
                'type' => Controls_Manager::MEDIA,
                'description' => esc_html__('Upload an SVG file to replace the default arrow icon.', 'ftelements'),
            ]
        );
        ...
        $repeater->add_control(
            'event_day',
            [
                'label' => esc_html__('Day', 'ftelements'),
                'type' => Controls_Manager::TEXT,
                'default' => '15',
                'label_block' => true,
            ]
        ...
        $repeater->add_control(
            'event_date',
            [
                'label' => esc_html__('Month / Year', 'ftelements'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('March, 2026', 'ftelements'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'event_title',
            [
                'label' => esc_html__('Event Title', 'ftelements'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Community Service Event', 'ftelements'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'event_link',
            [
                'label' => esc_html__('Event Link', 'ftelements'),
        ...
        $repeater->add_control(
            'event_location',
            [
                'label' => esc_html__('Location', 'ftelements'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Australia', 'ftelements'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Time: 6:00am To 8:00pm', 'ftelements'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'event_image',
            [
                'label' => esc_html__('Event Image', 'ftelements'),
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => $theme_uri . '/assets/img/home-1/activities-image.jpg',
                ],
            ]
        );
        ...
        $repeater->add_control(
            'is_active',
            [
                'label' => esc_html__('Highlight Item', 'ftelements'),
        ...
        $this->add_control(
            'event_items',
            [
                'label' => esc_html__('Event Items', 'ftelements'),
                ...
                'default' => [
                    [
                        'event_day' => '15',
                        'event_date' => esc_html__('March, 2026', 'ftelements'),
                        'event_title' => esc_html__('Community Service Event', 'ftelements'),
                        'event_location' => esc_html__('Australia', 'ftelements'),
                        'event_time' => esc_html__('Time: 6:00am To 8:00pm', 'ftelements'),
                        'event_image' => ['url' => $theme_uri . '/assets/img/home-1/activities-image.jpg'],
                    ],
                    [
                        'event_day' => '19',
                        'event_date' => esc_html__('March, 2026', 'ftelements'),
                        'event_title' => esc_html__('Community Care Campaign', 'ftelements'),
                        'event_location' => esc_html__('Australia', 'ftelements'),
                        'event_time' => esc_html__('Time: 6:00am To 8:00pm', 'ftelements'),
                        'event_image' => ['url' => $theme_uri . '/assets/img/home-1/activities-image-2.jpg'],
                        'is_active' => 'yes',
                    ],
                    [
                        'event_day' => '21',
                        'event_date' => esc_html__('March, 2026', 'ftelements'),
                        'event_title' => esc_html__('Volunteer Service Day', 'ftelements'),
                        'event_location' => esc_html__('Australia', 'ftelements'),
                        'event_time' => esc_html__('Time: 6:00am To 8:00pm', 'ftelements'),
                        'event_image' => ['url' => $theme_uri . '/assets/img/home-1/activities-image-3.jpg'],
                    ],
                ],
            ]
        );
        ...
        $this->add_control(
            'wow_start_delay',
            [
                'label' => esc_html__('Animation Start Delay (s)', 'ftelements'),
        ...
        $this->add_control(
            'wow_delay_step',
            [
                'label' => esc_html__('Animation Delay Step (s)', 'ftelements'),
                'type' => Controls_Manager::NUMBER,
                'default' => 0.2,
                'min' => 0,
                'step' => 0.1,
    ...
    protected function register_style_controls()
    {
        ...
        $this->start_controls_section(
            'event_style_section_card',
            [
                'label' => esc_html__('Event Card', 'ftelements'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .activities-wrapper-items.style-event' => 'background-color: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'style_card_bg_active',
            [
                'label' => esc_html__('Active Background Color', 'ftelements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .activities-wrapper-items.style-event.active' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .activities-wrapper-items.style-event',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .activities-wrapper-items.style-event' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem'],
                'selectors' => [
                    '{{WRAPPER}} .activities-wrapper-items.style-event' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'style_card_gap',
            [
                'label' => esc_html__('Card Gap', 'ftelements'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', 'rem'],
                'selectors' => [
                    '{{WRAPPER}} .activities-wrapper-items.style-event' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'event_style_section_date',
            [
                'label' => esc_html__('Date Area', 'ftelements'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'style_day_color',
            [
                'label' => esc_html__('Day Color', 'ftelements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .activities-wrapper-items .content > span' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'style_date_color',
            [
                'label' => esc_html__('Month/Year Color', 'ftelements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .activities-wrapper-items .content h3' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'style_date_typography',
                'selector' => '{{WRAPPER}} .activities-wrapper-items .content h3',
            ]
        );

        $this->add_responsive_control(
            'style_date_badge_width',
            [
                'label' => esc_html__('Date Badge Width', 'ftelements'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .activities-wrapper-items .date-top img' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'event_style_section_title_meta',
            [
                'label' => esc_html__('Title & Meta', 'ftelements'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );

        $this->add_control(
            'style_event_title_color',
            [
                'label' => esc_html__('Event Title Color', 'ftelements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rights-content h3 a' => 'color: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'style_event_title_hover_color',
            [
                'label' => esc_html__('Event Title Hover Color', 'ftelements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rights-content h3 a:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'style_event_title_typography',
                'selector' => '{{WRAPPER}} .rights-content h3 a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rights-content ul li' => 'color: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'style_meta_icon_color',
            [
                'label' => esc_html__('Meta Icon Color', 'ftelements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rights-content ul li i' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'style_meta_typography',
                'selector' => '{{WRAPPER}} .rights-content ul li',
            ]
        );

        $this->add_responsive_control(
            'style_meta_item_spacing',
            [
                'label' => esc_html__('Meta Item Spacing', 'ftelements'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', 'rem'],
                'selectors' => [
                    '{{WRAPPER}} .rights-content ul li:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .thumb-items .thumb img' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'vh'],
                'selectors' => [
                    '{{WRAPPER}} .thumb-items .thumb img' => 'height: {{SIZE}}{{UNIT}}; object-fit: cover;',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .thumb-items .thumb img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'style_image_spacing',
            [
                'label' => esc_html__('Image Right Spacing', 'ftelements'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', 'rem'],
                'selectors' => [
                    '{{WRAPPER}} .thumb-items .thumb' => 'margin-right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'style_arrow_bg_color',
            [
                'label' => esc_html__('Button Background Color', 'ftelements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .thumb-items .icon .bg' => 'background-color: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'style_arrow_bg_hover_color',
            [
                'label' => esc_html__('Button Hover Background Color', 'ftelements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .thumb-items .icon:hover .bg' => 'background-color: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'style_arrow_icon_color',
            [
                'label' => esc_html__('Arrow Icon Color', 'ftelements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .thumb-items .icon svg path' => 'stroke: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .thumb-items .icon' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .thumb-items .icon .bg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .thumb-items .icon .bg' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $date_badge = !empty($settings['date_badge_image']['url']) ? $settings['date_badge_image']['url'] : '';
        $arrow_icon_svg = !empty($settings['arrow_icon_svg']['url']) ? $settings['arrow_icon_svg']['url'] : '';
        $event_items = !empty($settings['event_items']) ? $settings['event_items'] : [];
        ...
        <section class="activities-section fix section-padding bg-cover" <?php echo $section_bg ? 'style="background-image:url(' . esc_url($section_bg) . ');"' : ''; ?>>
            <div class="container">
                ...
                <?php foreach ($event_items as $index => $item) : ?>
                    <?php
                    $item_title = !empty($item['event_title']) ? $item['event_title'] : esc_html__('Event', 'ftelements');
                    $item_image = !empty($item['event_image']['url']) ? $item['event_image']['url'] : '';
                    $link = !empty($item['event_link']['url']) ? $item['event_link']['url'] : '#';
                    $target = !empty($item['event_link']['is_external']) ? ' target="_blank"' : '';
                    $nofollow = !empty($item['event_link']['nofollow']) ? ' rel="nofollow"' : '';
                    $delay = $wow_start + ($index * $wow_step);
                    $item_classes = 'activities-wrapper-items style-event wow fadeInUp';
                    if (!empty($item['is_active']) && $item['is_active'] === 'yes') {
                        $item_classes .= ' active';
                    }
                    ?>
                    <div class="<?php echo esc_attr($item_classes); ?>" data-wow-delay="<?php echo esc_attr(number_format($delay, 1)); ?>s">
                        <?php if ($date_badge) : ?>
                            <div class="date-top">
                                <img src="<?php echo esc_url($date_badge); ?>" alt="<?php echo esc_attr($item_title); ?>">
                            </div>
                        <?php endif; ?>
                        <div class="bg-shape"></div>
                        <div class="content">
                            <?php if (!empty($item['event_day'])) : ?>
                                <span><?php echo esc_html($item['event_day']); ?></span>
                            <?php endif; ?>
                            <?php if (!empty($item['event_date'])) : ?>
                                <h3><?php echo esc_html($item['event_date']); ?></h3>
                            <?php endif; ?>
                        </div>
                        <div class="right-items">
                            <div class="thumb-items">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo esc_url($link); ?>" class="icon" aria-label="<?php echo esc_attr($item_title); ?>"<?php echo $target . $nofollow; ?>>
                                    <span class="bg"></span>
                                    <div class="arrow-icon">
                                        <?php if ($arrow_icon_svg) : ?>
                                            <img src="<?php echo esc_url($arrow_icon_svg); ?>" alt="<?php echo esc_attr($item_title); ?>">
                                        <?php else : ?>
                            ...
                            <div class="rights-content">
                                <h3>
                                    <a href="<?php echo esc_url($link); ?>"<?php echo $target . $nofollow; ?>><?php echo esc_html($item_title); ?></a>
                                </h3>
                                <ul>
                                    <?php if (!empty($item['event_location'])) : ?>
                                        <li>
                                            <i class="fa-regular fa-location-dot"></i>
                                            <?php echo esc_html($item['event_location']); ?>
                                        </li>
                                    <?php endif; ?>
                                    <?php if (!empty($item['event_time'])) : ?>
                                        <li>
                                            <i class="fa-regular fa-clock"></i>
                                            <?php echo esc_html($item['event_time']); ?>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </div>
