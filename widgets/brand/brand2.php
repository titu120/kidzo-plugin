...
class FT_Brand_2_Widget extends \Elementor\Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__('Together Forwar', 'ftelements'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'item_text' => esc_html__('Together Forwar', 'ftelements'),
                    ],
                    [
                        'item_text' => esc_html__('Together Forwar', 'ftelements'),
                    ],
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .marquee .text img' => 'margin-right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .marquee .text img' => 'width: {{SIZE}}{{UNIT}}; height: auto;',
                ],
            ]
        );
        ...
        $this->add_control(
            'image_padding',
            [
                'label' => esc_html__('Image Padding', 'ftelements'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .marquee-section' => 'max-width: {{SIZE}}{{UNIT}}; margin-left: auto; margin-right: auto;',
                ],
            ]
        );
