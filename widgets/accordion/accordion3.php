...
class FT_Accordion3_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('FT Accordion 3', 'ftelements');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'faq_train_shape_image',
            [
                'label'   => esc_html__('Train Shape Image', 'ftelements'),
                'type'    => Controls_Manager::MEDIA,
                'default' => [
                    'url' => Utils::get_placeholder_image_src(),
                ],
    ...
    protected function render()
    {
        ...
        $train_shape_image_url = !empty($settings['faq_train_shape_image']['url']) ? $settings['faq_train_shape_image']['url'] : '';
        $vec_shape_image_url = !empty($settings['faq_vec_shape_image']['url']) ? $settings['faq_vec_shape_image']['url'] : '';

        ?>
        <div class="faq-section-3 fix section-padding">
            <div class="train-shape float-bob-y">
                <?php if (!empty($train_shape_image_url)) : ?>
                    <img src="<?php echo esc_url($train_shape_image_url); ?>" alt="<?php echo esc_attr($settings['faq_title']); ?>">
                <?php endif; ?>
            </div>
            <div class="vec-shape">
                <?php if (!empty($vec_shape_image_url)) : ?>
                    <img src="<?php echo esc_url($vec_shape_image_url); ?>" alt="<?php echo esc_attr($settings['faq_title']); ?>">
                <?php endif; ?>
            </div>
            <div class="container">
                <div class="row g-4">
                    <div class="col-lg-6 order-2 order-lg-1">
                        <div class="faq-content-1 mt-0">
                            <ul class="accordion-box mt-0 list-unstyled">
                                <?php foreach ($faq_items as $index => $item) : ?>
                                    <li class="accordion block <?php echo $index === 0 ? 'active-block' : ''; ?> wow fadeInUp" <?php echo $index > 0 ? 'data-wow-delay=".' . esc_attr($index * 2) . 's"' : ''; ?>>
                    ...
                    <div class="col-lg-6 order-1 order-lg-2">
                        <div class="faq-content-1 faq-content-3 mt-0">
                            ...
                            <div class="faq-image-3 wow fadeInUp" data-wow-delay=".5s">
