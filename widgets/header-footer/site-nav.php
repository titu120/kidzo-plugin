	...
	protected function register_style_content_controls() {
		...
		$this->start_controls_tabs( 'tabs_menu_item_style' );
			$this->start_controls_tab(
				...
				$this->add_control(
					'header_bg_color_main_menu',
					[
						'label'     => __( 'Header Background Color', 'tp-elements' ),
						'type'      => Controls_Manager::COLOR,
						'global'    => [
							'default' => Global_Colors::COLOR_TEXT,
						],
						'default'   => '',
						'selectors' => [
							'#themephi-header .header-inner2' => 'background: {{VALUE}}',
						],
					]
				);	
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'#themephi-header .header-inner.tp-sticky' => 'background: {{VALUE}} !important',
						'#themephi-header.header-style-sticky.sticky .bg-remove' => 'background: {{VALUE}} !important',
					],
				]
			);	
			...
			$this->add_group_control(
				...
				[
					...
					'selector'  => '#themephi-header .menu-sticky.sticky',
					'separator' => 'after',
				]
			);
