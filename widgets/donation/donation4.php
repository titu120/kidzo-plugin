...
class FT_Donation_4_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('FT Donation 4', 'ftelements');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => Controls_Manager::TEXTAREA,
                'default' => esc_html__('We work with babies, children and young people in their families, schools and communities to ensure they grow up to be healthy and happy people in their families.', 'ftelements'),
            ]
        );
        ...
        $this->add_control(
            'donate_button_text',
            [
                'label'   => esc_html__('Donate Button Text', 'ftelements'),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'donate_button_link',
            [
                'label'         => esc_html__('Donate Button Link', 'ftelements'),
                'type'          => Controls_Manager::URL,
                'placeholder'   => esc_html__('https://your-link.com', 'ftelements'),
                'default'       => [
                    'url'         => '#',
        ...
        $this->start_controls_section(
            'style_button',
            [
                'label' => esc_html__('Button (CTA)', 'ftelements'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
        ...
        // Style: Donation wrapper (right column container)
        $this->start_controls_section(
        ...
        // Style: Intro text (donation form intro)
        $this->start_controls_section(
            'style_intro',
            [
                'label' => esc_html__('Intro Text', 'ftelements'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .amount-btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            'amount_list_margin',
            [
                'label'      => esc_html__('List Spacing Below', 'ftelements'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'selectors'  => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .custom-amount' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        // Style: Donate button (form button)
        $this->start_controls_section(
            'style_donate_button',
            [
    ...
    protected function render()
    {
        ...
        ?>
        <section class="grt-donate-section-2 fix section-bg section-padding">
            <div class="line-1">
                <img src="assets/img/home-2/shape/line-1.png" alt="img">
            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="grt-section-title mb-0">
                                <span class="grt-sub-title tz-sub-tilte tz-sub-anim tx-subTitle color-yellow">
                                    <?php \Elementor\Icons_Manager::render_icon( $settings['subtitle_icon'], [ 'aria-hidden' => 'true' ] ); ?> <?php echo esc_html( $settings['subtitle'] ); ?>
                                </span>
                                ...
                                <a href="<?php echo esc_url( $button_link ); ?>" class="theme-btn wow fadeInUp" data-wow-delay=".5s"<?php echo $button_target . $button_nofollow; ?>><?php echo esc_html( $settings['button_text'] ); ?> <i class="fa-regular fa-arrow-up-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-6">
