...
class FT_Contact3_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('FT Contact 3', 'ftelements');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'rows'        => 3,
                'description' => esc_html__('Paste your form plugin shortcode here.', 'ftelements'),
            ]
        );
        ...
        $this->add_control(
            'email_label',
            [
                'label'       => esc_html__('Email Label', 'ftelements'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Make a Quote', 'ftelements'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'email_address',
            [
                'label'       => esc_html__('Email Address', 'ftelements'),
                'type'        => Controls_Manager::TEXT,
                'default'     => 'kidzu@gmail.com',
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'location_label',
            [
                'label'       => esc_html__('Location Label', 'ftelements'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Location', 'ftelements'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'location_text',
            [
                'label'       => esc_html__('Location Text', 'ftelements'),
                'type'        => Controls_Manager::TEXTAREA,
                'default'     => esc_html__('4517 Washington ave.', 'ftelements'),
                'rows'        => 2,
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .contact-content',
            ]
        );
        ...
        $this->start_controls_section(
            'contact_form_description_style',
            [
                'label' => esc_html__('Description', 'ftelements'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        ...
        $this->add_control(
            'contact_form_description_color',
            [
                'label'     => esc_html__('Color', 'ftelements'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name'     => 'contact_form_description_typography',
                'selector' => '{{WRAPPER}} .contact-content > p',
            ]
        );

        $this->add_responsive_control(
            'contact_form_description_margin',
            [
                'label'      => esc_html__('Margin', 'ftelements'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .contact-form-items input:not([type="submit"]):not([type="button"]), {{WRAPPER}} .contact-form-items textarea, {{WRAPPER}} .contact-form-items select' => 'color: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'contact_form_input_placeholder_color',
            [
                'label'     => esc_html__('Placeholder Color', 'ftelements'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .contact-form-items input::placeholder, {{WRAPPER}} .contact-form-items textarea::placeholder' => 'color: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'contact_form_input_background_color',
            [
                'label'     => esc_html__('Background Color', 'ftelements'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .contact-form-items input:not([type="submit"]):not([type="button"]), {{WRAPPER}} .contact-form-items textarea, {{WRAPPER}} .contact-form-items select' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name'     => 'contact_form_input_typography',
                'selector' => '{{WRAPPER}} .contact-form-items input:not([type="submit"]):not([type="button"]), {{WRAPPER}} .contact-form-items textarea, {{WRAPPER}} .contact-form-items select',
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name'     => 'contact_form_input_border',
                'selector' => '{{WRAPPER}} .contact-form-items input:not([type="submit"]):not([type="button"]), {{WRAPPER}} .contact-form-items textarea, {{WRAPPER}} .contact-form-items select',
            ]
        );

        $this->add_responsive_control(
            'contact_form_input_radius',
            [
                'label'      => esc_html__('Border Radius', 'ftelements'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .contact-form-items input:not([type="submit"]):not([type="button"]), {{WRAPPER}} .contact-form-items textarea, {{WRAPPER}} .contact-form-items select' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'contact_form_input_padding',
            [
                'label'      => esc_html__('Padding', 'ftelements'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .contact-form-items input:not([type="submit"]):not([type="button"]), {{WRAPPER}} .contact-form-items textarea, {{WRAPPER}} .contact-form-items select' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'contact_form_input_spacing',
            [
                'label'     => esc_html__('Field Spacing', 'ftelements'),
                'type'      => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .contact-form-items p' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_control(
            'contact_form_label_heading',
            [
                'label' => esc_html__('Labels', 'ftelements'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .contact-form-items label' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name'     => 'contact_form_label_typography',
                'selector' => '{{WRAPPER}} .contact-form-items label',
            ]
        );
        ...
        $this->start_controls_tabs('contact_form_button_style_tabs');
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .contact-form-items input[type="submit"], {{WRAPPER}} .contact-form-items button[type="submit"]' => 'color: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'contact_form_button_background_color',
            [
                'label'     => esc_html__('Background Color', 'ftelements'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .contact-form-items input[type="submit"], {{WRAPPER}} .contact-form-items button[type="submit"]' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .contact-form-items input[type="submit"]:hover, {{WRAPPER}} .contact-form-items button[type="submit"]:hover' => 'color: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'contact_form_button_background_hover_color',
            [
                'label'     => esc_html__('Background Color', 'ftelements'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .contact-form-items input[type="submit"]:hover, {{WRAPPER}} .contact-form-items button[type="submit"]:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .contact-form-items input[type="submit"], {{WRAPPER}} .contact-form-items button[type="submit"]',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .contact-form-items input[type="submit"], {{WRAPPER}} .contact-form-items button[type="submit"]' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .contact-form-items input[type="submit"], {{WRAPPER}} .contact-form-items button[type="submit"]' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        if (!empty($settings['phone_number'])) {
            $phone_link = preg_replace('/[^0-9\+]/', '', $settings['phone_number']);
        }

        $email_address = !empty($settings['email_address']) ? sanitize_email($settings['email_address']) : '';
        $contact_image_url = !empty($settings['contact_image']['url']) ? $settings['contact_image']['url'] : '';

        if (!empty($settings['video_url']['url'])) {
            $this->add_link_attributes('video_url', $settings['video_url']);
        }
                            ...
                            <div class="contact-left-items">
                                <div class="contact-info-area-2">
                                        ...
                                        <div class="content">
                                            ...
                                            <h2>
                                                <?php if (!empty($phone_link)) : ?>
                                                    <a href="tel:<?php echo esc_attr($phone_link); ?>"><?php echo esc_html($settings['phone_number']); ?></a>
                                                <?php else : ?>
                                    ...
                                    <div class="contact-info-items mb-4">
                                        ...
                                        <div class="content">
                                            <p><?php echo esc_html($settings['email_label']); ?></p>
                                            <h2>
                                                <?php if (!empty($email_address)) : ?>
                                                    <a href="mailto:<?php echo esc_attr($email_address); ?>"><?php echo esc_html($settings['email_address']); ?></a>
                                                <?php else : ?>
                                    ...
                                    <div class="contact-info-items border-none">
                                        ...
                                        <div class="content">
                                            <p><?php echo esc_html($settings['location_label']); ?></p>
                                            <h2>
                                                <?php echo esc_html($settings['location_text']); ?>
                                            </h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="video-image">
                                    <?php if (!empty($contact_image_url)) : ?>
                                        <img src="<?php echo esc_url($contact_image_url); ?>" alt="<?php echo esc_attr($settings['form_title']); ?>">
                                    <?php endif; ?>
                                    <div class="video-box">
                                        <?php if (!empty($settings['video_url']['url'])) : ?>
                                            <a <?php echo $this->get_render_attribute_string('video_url'); ?> class="video-btn video-popup">
                            ...
                            <div class="contact-content">
                                ...
                                <div class="contact-form-items">
                                    ...
                                    if (!empty($settings['form_shortcode'])) {
                                        echo do_shortcode(wp_kses_post($settings['form_shortcode']));
                                    }
                                    ?>
                                </div>
                            </div>
